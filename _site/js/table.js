...
function appendEvent( event ) {
  ...
  eventElement   = $('<div class="event"><a target="_blank" href="' + event.tickets + '">' + event.name + '</a> @ ' + event.location + ' <br /><i class="fa fa-comments-o"> ' + event.theme + ' <br /><i class="fa fa-user"> ' + event.contact + '</div>')
